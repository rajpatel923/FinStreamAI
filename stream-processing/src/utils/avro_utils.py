...
class StreamAvroSerializer:
    """Confluent wire-format Avro serialize + deserialize for stream-processing."""
...
avro_serializer = StreamAvroSerializer(settings.SCHEMA_REGISTRY_URL)
